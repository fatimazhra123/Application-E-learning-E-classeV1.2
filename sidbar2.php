...
echo '<div class="row flex fixed-top ">
<div
    ...
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100">
        ...
        <div class="Admin rounded-circle text-center ">
            ...
            <p class="fs-5 fw-bold mb-1 text-center text-dark fs-6">Admin name</p>
            <p class="fs-5 fw-bold  text-center text-info fs-4">Admin</p>
        </div>
...
<li class=" form">
            ...
            <li class="form  ">
                <a href="payements.php" class="nav-link align-middle px-0 ">
        ...
        <div class="logo">
            <a href="index.php" class="nav-link align-middle px-0 mt-5 ps-3  ">
